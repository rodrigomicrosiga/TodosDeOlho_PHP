...
if ( is_null($cIDConv) ) 
{
	$cErrorMSG = "Convênio não informado.";
	$cErrorHLP = 'A busca não recebeu corretamente o código do Convênio a ser pesquisado. ' . 
...
Dados do Convênio <?php echo $cIDConv; ?>
</h3>
<div
  class="fb-like"
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from CONVENIOS where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from CRONOGRAMA_DESEMBOLSO where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from CRONOGRAMA_FISICO where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from EMPENHOS where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from EXECUCAOFIN where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from PLANOAP where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from PROPOSTAS_BANCOS where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from PROPOSTAS_BENEFESPECIF where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from PROPOSTAS_EMENDAP where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from PROPOSTAS_PROPONENTE where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
...
// ===================================================================================
$stmt = mysqli_prepare($conn, "Select * from PROPOSTAS_RESPONSAVEIS where ID_CONVENIO = ?");
mysqli_stmt_bind_param($stmt,'i',$cIDConv);
